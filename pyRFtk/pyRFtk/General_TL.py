...
"""
#FIXME: the scalers ae confusing ... e.g. if SCALER['OD'] == 'm' then the OD 
#       value supplied is in mm, but the GTL.f['OD'](0.) returns the data in mksA.
    ...
    def __str__(self):
        ...
        def strvar(var):
            ...
            if var in self.available:
                ...
                if var in []:
                    print()
                    print(var, self.f[var](0.),scale,unit)
                    print()
